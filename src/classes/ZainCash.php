...
class ZainCash extends MainClass
{
  ...
  public function __construct($redirectUrl, $lang)
  {
    //array $credentials
    parent::__construct("zaincash");

    $credentials = [
      'msisdn' => $this->Msisdn,
      'secret' => $this->Secret,
      'merchantid' => $this->Merchant_Id,
      'production_cred' => $this->productionZain,
      'language' => $lang, // 'en' or 'ar'
   ...
   */
  public function getPay(int $amount, string $service_type, string $order_id)
  {
